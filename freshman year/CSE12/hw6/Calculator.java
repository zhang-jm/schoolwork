...
public class Calculator {
        ...
        public Calculator (int tableSize) {
                symtab = new SymTab (tableSize);
                stack1 = new Stack ("Stack 1");
                stack2 = new Stack ("Stack 2");
        }
                ...
                while (!stack2.isEmpty ()) {
                        ...
                        /* operand found */
                                ...
                                // variable assignment
                                        ...
                                        Variable svar = 
					    op2.var.assign (operand1);
                                        symtab.insert (svar, 1);
        ...
        public long convertInToPost () 
				 ...
				 * parenthesis */
                        ...
                        /* operator must be encountered */
                                ...
                                word = new Word (character);
				/* to store on stack */

                                /* pop stack2 to stack1 until empty 
				 * or lower priority */
                                while (!stack2.isEmpty () &&
        ...
        static private long divide (long divisor, long dividend) {
                return dividend / divisor;
        }

        static private long exponent (long power, long base) {
                long retval = 1;
